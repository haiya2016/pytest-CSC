...
# https://github.com/defnngj/selenium_page_objects/blob/master/page_objects/page_objects.py
...
class PageElement(object):
    ...
    def __init__(self, context=False, time_out=None, describe=None, **kwargs):
        ...
        try:
            ...
            raise KeyError(
                "Please use a locator：'id_'、'name'、'class_'、'css'、'xpath'、'link_text'、'partial_link_text'.")
